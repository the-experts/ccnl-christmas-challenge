...
/**
 * This class is totally stolen from the first partition implementation I found on the internet.
 * It's basically a wrapper around a two-dimensional array to make my life easier.
 */
